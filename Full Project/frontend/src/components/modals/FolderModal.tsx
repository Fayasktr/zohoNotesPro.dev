  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-16 h-16 rounded-2xl bg-[#6d5dfc]/10 text-[#6d5dfc] border border-[#6d5dfc]/20 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-[#6d5dfc]/20">
          <FolderPlus className="w-8 h-8" />
        </div>

        <h2 className="text-lg font-bold text-white text-center mb-1">{title}</h2>
        <p className="text-xs text-slate-400 text-center mb-5">
          Organize your notebooks into workspace directories.
        </p>
